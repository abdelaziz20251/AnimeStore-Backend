    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('card', 'Credit/Debit Card'), ('cash_on_delivery', 'Cash on Delivery'), ('wallet', 'Wallet'), ('paypal', 'PayPal'), ('bank_transfer', 'Bank Transfer')], default='cash_on_delivery', max_length=50)),
